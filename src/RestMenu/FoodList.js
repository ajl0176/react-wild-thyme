...
class FoodList extends Component {
  ...
  render() {
    const appetizers = this.props.appetizers.map((appetizer)=> <FoodItem  addOrder={this.props.addOrder} deleteOrder={this.props.deleteORder} item={appetizer}/>);
    const entrees = this.props.entrees.map((entree)=> <FoodItem addOrder={this.props.addOrder} deleteOrder={this.props.deleteORder} item={entree}/>);
    return(
      <div className="col">
